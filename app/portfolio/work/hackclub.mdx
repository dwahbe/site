...
summary: 'Product manager & designer at HCB, The Hack Foundation's fiscal sponsorship program. Building tools for the next generation of nonprofits around the world.'
color: '#ec3750'
order: 3
role: 'Product Manager & Account Manager'
years: '2023–2025'
logo: HCBIconOriginal.png
...
- Aggregated customer feedback and direct product roadmap
- Created and wrote **HCB's monthly newsletter, grew audience to over 12K** with an average open rate above 55%
...
- Redesigned onboarding experience to increase user satisfaction and reduce long-term customer support time
