...
color: '#ffde16'
order: 4
role: 'Hub Director & Founding Member'
years: '2020–2023'
logo: sunrisemovement.png
...
<div className="grid gap-4 md:grid-cols-3 italic">
  <RichLink
    ...
    image="/portfolio/rolling-stone.png"
  ...
  <RichLink
    ...
    image="/portfolio/democracy-now.png"
...
- Helped start Sunrise NYU, official chapter of the Sunrise Movement
